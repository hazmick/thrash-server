...
router.route("/").post(async (req, res) => {
  ...
  try {
    ...
    if (event.data.pricing.local.amount == "20.00") {
      ...
      if (event.type === "charge:confirmed") {
        ...
        const emailData = {
          ...
          to: person,
          subject: "Hazmick has recieved your Membership Fee",
          html: `<!DOCTYPE html>
          <html
                                        ...
                                        <tr>
                                          ...
                                          >
                                            <img
                                              align="center"
                                              alt=""
                                              src="https://mcusercontent.com/ee211ee50eb5d503aa1142778/imgs/19d8d41a-cd5b-387b-6c05-dcb390ae84c8.png"
                                              width="555"
                                              style="
                                                max-width: 555px;
                                                padding-bottom: 0;
                                        ...
                                        <tr>
                                          ...
                                          >
                                            <h1 style="text-align: center">
                                              We have recieved your Subscription plan
                                            </h1>
          
                                            <p style="text-align: center">
                                              Your account is now fully authorized and
                                              your Mick Bots is ready with your
                                              spreadsheet, You are now eligible to choose
                                              a payment package.
                                            </p>
                                          </td>
                                        </tr>
        ...
        setTimeout(async () => {
          ...
          const emailData = {
            from: process.env.EMAIL_FROM,
            to: person,
            subject: "Your account is now fully Authorized",
            html: `<!DOCTYPE html>
            <html
              xmlns="http://www.w3.org/1999/xhtml"
              xmlns:v="urn:schemas-microsoft-com:vml"
          ...
          console.log("Upgraded to Level Two");
        }, 345600000);
    ...
    } else if (event.data.pricing.local.amount == "100.00") {
      if (event.type === "charge:pending") {
        console.log("Payment On the way");
        return res.json("Payment on the way");
      }
      ...
      if (event.type === "charge:confirmed") {
        ...
        userInDb.level = 3;
        userInDb.plan.plan_fee = event.data.pricing.local.amount;
        userInDb.plan.plan_name = event.data.name;
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          >
                                            ...
                                            <p style="text-align: center">
                                              Your account is now fully authorized and
                                              your Mick Bots is ready. You can now start trading.
                                            </p>
                                          </td>
                                        </tr>
                                      </tbody>
    ...
    } else if (event.data.pricing.local.amount == "300.00") {
      if (event.type === "charge:pending") {
        console.log("Payment On the way");
        return res.json("Payment on the way");
      }
    ...
    } else if (event.data.pricing.local.amount == "500.00") {
      if (event.type === "charge:pending") {
        console.log("Payment On the way");
        return res.json("Payment on the way");
      }
    ...
    } else if (event.data.pricing.local.amount == "1000.00") {
      if (event.type === "charge:pending") {
        console.log("Payment On the way");
        return res.json("Payment on the way");
      }
    ...
    } else if (event.data.pricing.local.amount == "5000.00") {
      if (event.type === "charge:pending") {
        console.log("Payment On the way");
        return res.json("Payment on the way");
      }
    ...
    }  else if (event.data.pricing.local.amount == "10000.00") {
      if (event.type === "charge:pending") {
        console.log("Payment On the way");
        return res.json("Payment on the way");
      }
